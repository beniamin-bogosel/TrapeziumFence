...
\begin{description}
  ...
  diagonal-style bounds from each survivor rectangle to the reference
  trapezoid.
...
\[
\begin{aligned}
R_C&=[0.626953125,\ 0.669921875]\times[0.677734375,\ 0.7353515625],\\
R_D&=[0.330078125,\ 0.373046875]\times[0.677734375,\ 0.7353515625].
\end{aligned}
\]
...
metric used by the analysis script, is \(0.045713093\).

The command
\begin{lstlisting}
python3 analyze_refinement_distances.py
\end{lstlisting}
computes diagonal-style Euclidean upper bounds from each refinement's survivor
rectangles to the reference trapezoid.  For the displayed product rectangle
\(R_C\times R_D\), the \(C\)- and \(D\)-bounds are farthest-corner distances
from \(C^\ast\) and \(D^\ast\), and the four-dimensional product bound is their
...
\toprule
File & Survivors & \(C\) bound & \(D\) bound & 4D product & Max leaf 4D \\
\midrule
\code{flat_pair_cert_w0025.jsonl} & 69787 & 0.925578382 & 0.898853283 &
1.2902064 & 0.832882346 \\
\code{flat_pair_refine_w00125.jsonl} & 25031 & 0.647089329 & 0.61938547 &
...
\[
\begin{aligned}
&696{,}022\text{ leaves},\quad 14{,}550\text{ discarded},\quad
478{,}332\text{ certified},\\
&213\text{ flat-area},\quad 194{,}689\text{ nonoptimal},\quad
8{,}238\text{ survivors}.
\end{aligned}
\]
