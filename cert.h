 ...
 *    "status":"discarded|certified|flat_area|pair_incompatible|survivor",
 *    "item":<int, -1 if none>,
 *    "encl":[flo,fhi] or [null,null] when no candidate enclosure applies,
 *    "prec":<int>}
 *
 ...
 * accepts legacy "nonoptimal" records as pair-incompatible records and also
 * checks that the leaves form the complete dyadic partition of the root box
 * generated by the splitter, so truncated or overlapping certificates fail.
 */
#ifndef TRAP_CERT_H
#define TRAP_CERT_H
